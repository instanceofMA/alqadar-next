export default function Features() {
    ...
    return <div>
        { features.map(({ highlight, title, description, cta, image, review, reviewer }, index) => {
                        ...
                        <div className="group mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
                            <div className="lg:pr-4 lg:pt-4">
                                <div className="lg:max-w-lg">
                                    ...
                                    <div className="mt-8">
                                        <a href="#" className="inline-flex rounded-md bg-orange-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">{cta}</a>
                                    </div>
                            ...
                            <img src={image} alt="Product screenshot" className="hover:-translate-y-10 transition ease-in-out duration-500 w-[48rem] h-[35rem] max-w-none rounded-xl shadow-xl ring-1 ring-orange-400/10 sm:w-[57rem] md:-ml-4 lg:ml-0" width="2432" height="1442" />
                        </div>
                    </div>
                </div>
            </section>;
